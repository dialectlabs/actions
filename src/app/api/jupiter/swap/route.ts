...
// original url: https://jup.ag/swap/USDC-SOL
app.openapi(createRoute({
  ...
  const [inputTokenMeta, outputTokenMeta] = await Promise.all([
    lookupToken(inputToken),
    lookupToken(outputToken)
  ]);
